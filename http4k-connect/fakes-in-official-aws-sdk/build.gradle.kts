...
dependencies {
    ...
    implementation(libs.aws.sdk.dynamodb) // Use the official V2 AWS SDK in your production code
    implementation(libs.aws.sdk.s3) // Use the official V2 AWS SDK in your production code
