...
//                """.trimIndent(), "Find all build.gradle.kts files and extract module paths"
//            ) {
//                id = "set-modules"
//
//            }
...
//            needs += discover
//
//            strategy = io.typeflows.github.workflow.Strategy(
//                mapOf("module" to listOf($$"""${{ fromJson(needs.discover_modules.outputs.modules) }}"""))
//            ) {
//
//            }
//            steps += Checkout()
//            steps += SetupJava(Temurin, V21, "Setup Java")
//            steps += RunCommand("./gradlew build", "Build and test module")
//            steps += UseAction("TimonVS/pr-labeler-action@v5.0.0", "Tag automerge branch") {
